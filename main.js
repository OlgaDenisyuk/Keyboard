const matrix = [
    ...
    row1 = [
        ...
        {keyCode: 69, shifted_ru: 'Ó', shifted_en: 'E', en: 'e', ru: 'ó', width:1 },
        {keyCode: 82, shifted_ru: 'Ê', shifted_en: 'R', en: 'r', ru: 'ê', width:1 },
        {keyCode: 84, shifted_ru: 'Å', shifted_en: 'T', en: 't', ru: 'å', width:1 },
        {keyCode: 89, shifted_ru: 'Í', shifted_en: 'Y', en: 'y', ru: 'í', width:1 },
        {keyCode: 85, shifted_ru: 'Ã', shifted_en: 'U', en: 'u', ru: 'ã', width:1 },
        {keyCode: 73, shifted_ru: 'Ø', shifted_en: 'I', en: 'i', ru: 'ø', width:1 },
        {keyCode: 79, shifted_ru: 'Ù', shifted_en: 'O', en: 'o', ru: 'ù', width:1 },
        {keyCode: 80, shifted_ru: 'Ç', shifted_en: 'P', en: 'p', ru: 'ç', width:1 },
        {keyCode: 219, shifted_ru: 'Õ', shifted_en: '{', en: '[', ru: 'õ', width:1 },
        {keyCode: 221, shifted_ru: 'Ú', shifted_en: '}', en: ']', ru: 'ú', width:1 },
    ...
    row2 = [
        ...
        {keyCode: 68, shifted_ru: 'Â', shifted_en: 'D', en: 'd', ru: 'â', width:1 },
        {keyCode: 70, shifted_ru: 'À', shifted_en: 'F', en: 'f', ru: 'à', width:1 },
        {keyCode: 71, shifted_ru: 'Ï', shifted_en: 'G', en: 'g', ru: 'ï', width:1 },
        {keyCode: 72, shifted_ru: 'Ð', shifted_en: 'H', en: 'h', ru: 'ð', width:1 },
        {keyCode: 74, shifted_ru: 'Î', shifted_en: 'J', en: 'j', ru: 'î', width:1 },
        {keyCode: 75, shifted_ru: 'Ë', shifted_en: 'K', en: 'k', ru: 'ë', width:1 },
        {keyCode: 76, shifted_ru: 'Ä', shifted_en: 'L', en: 'l', ru: 'ä', width:1 },
        {keyCode: 59, shifted_ru: 'Æ', shifted_en: ':', en: ';', ru: 'æ', width:1 },
    ...
    row3 = [
        ...
        {keyCode: 67, shifted_ru: 'Ñ', shifted_en: 'C', en: 'c', ru: 'ñ', width:1 },
        {keyCode: 86, shifted_ru: 'Ì', shifted_en: 'V', en: 'v', ru: 'ì', width:1 },
        {keyCode: 66, shifted_ru: 'È', shifted_en: 'B', en: 'b', ru: 'è', width:1 },
        {keyCode: 78, shifted_ru: 'Ò', shifted_en: 'N', en: 'n', ru: 'ò', width:1 },
        {keyCode: 77, shifted_ru: 'Ü', shifted_en: 'M', en: 'm', ru: 'ü', width:1 },
        {keyCode: 188, shifted_ru: 'Á', shifted_en: '<', en: ',', ru: 'á', width:1 },
        {keyCode: 190, shifted_ru: 'Þ', shifted_en: '>', en: '.', ru: 'þ', width:1 },
